...
import { Database, FolderCog, Images, Search, Settings, TimerReset } from 'lucide-react';
...
export function Layout() {
  return (
    <div className="flex min-h-screen bg-[#eef1f4] text-ink">
      <aside className="hidden w-64 border-r border-line bg-white lg:block">
